...
[Download](https://saucelabs.com/downloads/teamcity/release/com/saucelabs/teamcity/build/1.55/build-1.55.zip) the plugin zip file and copy it into your ~/.BuildServer/plugins directory
